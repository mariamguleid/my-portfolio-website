    ...
    <div name='experience' className='w-full md:h-screen text-gray-300 bg-[#0a192f]'>
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        <div className='pb-8 w-full flex justify-center items-center flex-col'>
          ...
          <p className='py-6 text-2xl'>Here is a list of some projects I've done</p>
        </div>
{/* Container */}
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100 flex justify-center items-center flex-col'>
              ...
              <p className='text-center'>Made this portfolio website and deployed it to GitPages</p>
              <div className='pt-8 text-center'>
              </div>
            </div>
          </div>
